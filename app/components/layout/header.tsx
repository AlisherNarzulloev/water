...
const NAV_ITEMS = [
  { label: "ПОЛЕЗНО ЗНАТЬ", href: "#" },
  { label: "АССОРТИМЕНТ", href: "#" },
  ...
  return (
    <header className="w-full bg-white shadow z-30">
      <nav className="container mx-auto flex items-center justify-between px-4 lg:px-8">
        ...
        <Link
          href="#"
          className="group flex items-center justify-center gap-2 bg-[#05A8E2] hover:bg-[#039cd2] transition px-14 py-8 text-white font-light rounded-none text-base"
        >
          ДОСТАВКА
